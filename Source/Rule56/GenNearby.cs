...
namespace CombatAI
{
    public static class GenNearby
    {
        public static void NearbyPawns(this IntVec3 root, Map map, List<Pawn> pawns, TraverseParms parms, int maxReigons, int maxDist, int maxNum, Predicate<Pawn> validator = null)
        {
            ...
            CombatAI.Compatibility.CompatHelpers.RegionwiseBFSWorker_NoOut(root, map, ThingRequest.ForGroup(ThingRequestGroup.Pawn), PathEndMode.InteractionCell, parms, func, null, 1, maxReigons, maxDist);
        }
    }
}
