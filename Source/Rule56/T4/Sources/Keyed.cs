...
namespace CombatAI.R
{
    ...
    public static class Keyed
    {
        ...
        private static TaggedString _CombatAI_Settings_Basic_FogOfWar_CloseInColony = null;
        /// <summary> Keyed string. key=<c>CombatAI.Settings.Basic.FogOfWar.CloseInColony</c>. inner text:
        ///
        /// <code>Close fow in colony map</code>
        /// </summary>       
        public static TaggedString CombatAI_Settings_Basic_FogOfWar_CloseInColony
        {
            get => _CombatAI_Settings_Basic_FogOfWar_CloseInColony != null ?
                   _CombatAI_Settings_Basic_FogOfWar_CloseInColony : _CombatAI_Settings_Basic_FogOfWar_CloseInColony = "CombatAI.Settings.Basic.FogOfWar.CloseInColony".Translate();
        }

        private static TaggedString _CombatAI_Settings_Basic_FogOfWar_CloseInColony_Description = null;
        /// <summary> Keyed string. key=<c>CombatAI.Settings.Basic.FogOfWar.CloseInColony.Description</c>. inner text:
        ///
        /// <code>When enabled, Combat AI's fog overlay is disabled on player colony (home) maps so the game's native unexplored fog is shown.</code>
        /// </summary>       
        public static TaggedString CombatAI_Settings_Basic_FogOfWar_CloseInColony_Description
        {
            get => _CombatAI_Settings_Basic_FogOfWar_CloseInColony_Description != null ?
                   _CombatAI_Settings_Basic_FogOfWar_CloseInColony_Description : _CombatAI_Settings_Basic_FogOfWar_CloseInColony_Description = "CombatAI.Settings.Basic.FogOfWar.CloseInColony.Description".Translate();
        }

        private static TaggedString _CombatAI_Settings_Basic_FogOfWar_UseVanillaUnexplored = null;
        /// <summary> Keyed string. key=<c>CombatAI.Settings.Basic.FogOfWar.UseVanillaUnexplored</c>. inner text:
        ///
        /// <code>Use vanilla unexplored overlay</code>
        /// </summary>       
        public static TaggedString CombatAI_Settings_Basic_FogOfWar_UseVanillaUnexplored
        {
            get => _CombatAI_Settings_Basic_FogOfWar_UseVanillaUnexplored != null ?
                   _CombatAI_Settings_Basic_FogOfWar_UseVanillaUnexplored : _CombatAI_Settings_Basic_FogOfWar_UseVanillaUnexplored = "CombatAI.Settings.Basic.FogOfWar.UseVanillaUnexplored".Translate();
        }

        private static TaggedString _CombatAI_Settings_Basic_FogOfWar_UseVanillaUnexplored_Description = null;
        /// <summary> Keyed string. key=<c>CombatAI.Settings.Basic.FogOfWar.UseVanillaUnexplored.Description</c>. inner text:
        ///
        /// <code>When enabled, CAI will write its invisible cells to the game's FogGrid so vanilla unexplored areas cover hidden cells.</code>
        /// </summary>       
        public static TaggedString CombatAI_Settings_Basic_FogOfWar_UseVanillaUnexplored_Description
        {
            get => _CombatAI_Settings_Basic_FogOfWar_UseVanillaUnexplored_Description != null ?
